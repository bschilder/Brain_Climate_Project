# New analysis with Shultz and Dunbar mammals plus Boddy Primates

### Load datasets and clean up species columns and column names
```{r}
brains <- read.table("brainclimatedata.txt", header=TRUE, sep="\t")
brains$Species<- gsub(" ", "_", brains$Species)

boddyprimates <- read.table("Boddy2012PrimateCC.csv", header=TRUE, sep=",")
